...
export const P1: CallSet = {
  ...
  random: (g, n) => [
    ...
    ...repeat('pathLength', n, () => [path(g), g.chance(0.5)]),
    ...repeat('centroid', n, () => [g.chance(0.7) ? g.ring(g.int(3, 12), 60, g.chance(0.5)) : path(g)]),
    ...
    ...repeat('distToSegment', n, () => [g.pt(), g.pt(), g.chance(0.2) ? g.gridPt() : g.pt()]),
    ...repeat('angleDeg', n, () => [g.pt(), g.chance(0.2) ? g.gridPt() : g.pt()]),
    ...repeat('bearingGrad', n, () => [g.gridPt(), g.chance(0.5) ? g.gridPt() : g.pt()]),
    ...repeat('translation', n, () => [g.num(-1e6, 1e6), g.num(-1e6, 1e6)]),
    ...repeat('rotation', n, () => [angle(g), g.chance(0.2) ? undefined : g.pt()]),
    ...repeat('scaling', n, () => [g.num(-5, 5), g.chance(0.2) ? undefined : g.pt()]),
    ...repeat('mirror', n, () => [g.pt(), g.chance(0.1) ? v(0, 0) : g.pt()]),
    ...repeat('compose', n, () => [affine(g), affine(g)]),
    ...repeat('apply', n, () => [affine(g), g.pt()]),
    ...repeat('applyLinear', n, () => [affine(g), g.pt(5)]),
    ...repeat('determinant', n, () => [affine(g)]),
    ...repeat('lengthScale', n, () => [affine(g)]),
    ...repeat('isReflection', n, () => [affine(g)]),
    ...repeat('normAngle', n, () => [angle(g)]),
    ...repeat('sweep', n, () => [angle(g), angle(g)]),
    ...repeat('onArc', n, () => [angle(g), angle(g), g.num(0, TAU), g.chance(0.3) ? g.num(0, 0.1) : undefined]),
    ...repeat('arcParam', n, () => [angle(g), angle(g), g.num(0.01, TAU)]),
    ...repeat('pointOnCircle', n, () => [g.pt(), g.num(0, 50), angle(g)]),
    ...repeat('circleThrough', n, () => (g.chance(0.3) ? [g.gridPt(), g.gridPt(), g.gridPt()] : [g.pt(), g.pt(), g.pt()])),
    ...repeat('arcThrough', n, () => (g.chance(0.3) ? [g.gridPt(), g.gridPt(), g.gridPt()] : [g.pt(), g.pt(), g.pt()])),
    ...repeat('tessellateArc', n, () => [arcGeom(g), g.chance(0.5) ? undefined : g.num(0.05, 1)]),
    ...repeat('arcStart', n, () => [arcGeom(g)]),
    ...repeat('arcEnd', n, () => [arcGeom(g)]),
    ...repeat('arcMid', n, () => [arcGeom(g)]),
    ...repeat('arcLength', n, () => [arcGeom(g)]),
    ...repeat('bulgeFromArc', n, () => [arcGeom(g)]),
    ...repeat('onEdgeArc', n, () => [arcEdge(g), angle(g)]),
    ...repeat('lineLine', n, () => (g.chance(0.4) ? [g.gridPt(), g.gridPt(), g.gridPt(), g.gridPt()] : [g.pt(), g.pt(), g.pt(), g.pt()])),
    ...repeat('segSeg', n, () => [...(g.chance(0.4) ? [g.gridPt(), g.gridPt(), g.gridPt(), g.gridPt()] : [g.pt(), g.pt(), g.pt(), g.pt()]), g.chance(0.3) ? g.num(0, 0.1) : undefined]),
    ...repeat('lineCircleParams', n, () => [g.pt(), g.pt(), g.pt(), g.num(0, 150)]),
    ...repeat('circleCircle', n, () => (g.chance(0.4) ? [g.gridPt(5, 2), g.pick([5, 10]), g.gridPt(5, 2), g.pick([5, 10])] : [g.pt(), g.num(0, 100), g.pt(), g.num(0, 100)])),
    ...repeat('paramOn', n, () => [edge(g), g.pt()]),
    ...repeat('pointAt', n, () => [edge(g), g.num(-0.5, 1.5)]),
    ...repeat('intersectEdges', n, () => [edge(g), edge(g)]),
    ...repeat('rayEdge', n, () => [g.pt(), g.pt(5), edge(g), g.chance(0.5) ? undefined : g.num(-1, 1)]),
    ...repeat('closestOnEdge', n, () => [edge(g), g.pt()]),
    ...repeat('perpendicularFoot', n, () => [edge(g), g.pt()]),
    ...repeat('fullCircle', n, () => [g.pt(), g.num(0, 50)]),
    ...repeat('tangentPoints', n, () => [g.pt(), g.pt(), g.num(0, 80)]),
    ...repeat('bulgeAt', n, () => [bulges(g, 4), g.int(0, 6)]),
    ...repeat('isArcBulge', n, () => [g.pick([0, 1e-13, -1e-11, g.num(-2, 2)])]),
    ...repeat('hasBulges', n, () => [bulges(g, g.int(0, 5))]),
    ...repeat('bulgeArc', n, () => [g.pt(), g.chance(0.1) ? v(0, 0) : g.pt(), g.pick([0, 1, -1, 1e-13, g.num(-3, 3)])]),
    ...repeat('bulgeOfSweep', n, () => [g.num(-TAU, TAU)]),
    ...repeat('segmentMid', n, () => [g.pt(), g.pt(), g.num(-2, 2)]),
    ...repeat('bulgeThrough', n, () => (g.chance(0.3) ? [g.gridPt(), g.gridPt(), g.gridPt()] : [g.pt(), g.pt(), g.pt()])),
    ...repeat('tangentBulge', n, () => [g.pt(), g.pt(1), g.chance(0.1) ? v(0, 0) : g.pt()]),
    ...repeat('segmentTangent', n, () => [g.pt(), g.pt(), g.num(-2, 2), g.chance(0.5)]),
    ...repeat('bulgePathEdges', n, () => {
      const p = path(g);
      return [p, bulges(g, p.length), g.chance(0.5)];
    }),
    ...repeat('bulgePathOutline', n, () => {
      const p = path(g);
      return [p, bulges(g, p.length), g.chance(0.5), g.chance(0.5) ? undefined : g.num(0.05, 1)];
    }),
    ...repeat('bulgePathLength', n, () => {
      const p = path(g);
      return [p, bulges(g, p.length), g.chance(0.5)];
    }),
    ...repeat('bulgeRingArea', n, () => {
      const p = g.chance(0.7) ? g.ring(g.int(3, 8), 40, g.chance(0.5)) : path(g);
      return [p, bulges(g, p.length)];
    }),
    ...repeat('reverseBulgePath', n, () => {
      const p = path(g);
      return [p, bulges(g, p.length), g.chance(0.5)];
    }),
    ...repeat('cleanBulgePath', n, () => {
      const p = path(g);

...
- `crates/wasm/formats-wasm` geometri çekirdeğinin paketinden ayrıdır (`src/io/pkg`). Çekirdek başlangıçta yüklenir; biçim modülü yalnız içe ya da dışa aktarmada.

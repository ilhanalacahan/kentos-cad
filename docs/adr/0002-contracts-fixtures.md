...
- **Tek kaynak `crates/shared/contracts`'tır.** `cargo test -p kentos-contracts`, ts-rs ile TypeScript tiplerini `src/contracts/generated/` altına yazar; bu dosyalar depoya girer.

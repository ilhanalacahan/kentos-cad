...
- **WASM paketi:** 896 139 bayt, gzip 302 678 bayt (sağlam kararlar R1–R3 ve paketli dönüşümle; önce 883 626 / 297 902; DXF yazıcısı değiştirmedi). Başlangıç sınırı kullanıcı kararıyla 300'den 350 KB gzip'e yükseltildi (24 Eylül, ADR 0005 “Değişiklikler”); işlev adları pakette kalır. Her çekirdek diliminden sonra boyut ADR 0008'e yazılır.

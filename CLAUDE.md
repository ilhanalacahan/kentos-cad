...
1. **CAD çekirdeği:**
   ...
   - **Netcad çizim eşdeğerliği (referans Netcad'dir; AutoCAD ikincil ölçüttür. Bağlayıcı hedef: çizim kusursuz olmadan başka işe geçilmez):**
     ...
     - *Eksik:* PLINE yay alt seçenekleri (açı, merkez, yön, yarıçap, ikinci nokta), Uzunluk ve kalınlık; CIRCLE TTT; DONUT; REVCLOUD; MTEXT; yol boyunca ARRAY; ROTATE/SCALE referans ve kopya ayrıntıları.

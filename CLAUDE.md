...
- Sağlam geometrik kararlar (§23.3) yolda: kesin yön yüklemi var (`geometry-core::predicates::orient2d`, Shewchuk'un uyarlamalı yüklemi, bağımlılıksız, bağımsız referansla; ADR 0008 “Sağlam kararlar”), ama çekirdeğin kararları henüz ona geçmedi: kesişim, yönelim, içerme ve ortak sınır kararları f64'te sabit toleranslarla verilir (kesişimde parametre 1e-9, bindirmede köşe birleştirme `TOL = 1e-6` m). Kararlar yalnız Rust'ta tek tek geçirilir; değişen sonuçlar golden dosyalara bilinçle işlenir.

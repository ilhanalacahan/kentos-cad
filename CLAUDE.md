...
- Tarama tek halka (ada/delik yok) ve ilişkisel değil: sınır değişince tarama güncellenmez. Adalı alanın içine tıklanınca tarama dış halkayı doldurur; adalı tarama `faceIndex` ile yapılacak.

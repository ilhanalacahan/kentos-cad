...
use kentos_contracts::{
    CommandEnvelope, ConflictReason, DocumentSnapshotV1, Entity, FeatureChange, PROJECT_CHANGES,
    PROJECT_DELETED, ProjectChanges, ProjectCreate, ProjectPatch, SignInMethod, TenantRole,
};
...
async fn new_project(db: &TestDb, who: &Access, name: &str) -> Uuid {
...
fn a_point(x: f64) -> ProjectChanges {

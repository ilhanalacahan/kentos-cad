...
- **SVG çizim düzenleyicisi:** 1320 px, üç sütun (210 / çizim / 330). Solda araç düğmeleri (simge, ad, sağda tuş; seçili araç amber tonlu) ve altında şekil listesi (öndeki üstte; göz düğmesi, grupta ▣). Ortada alan tonunda çalışma yüzeyi, üzerinde gölgeli kâğıt ve ince ızgara; seçim kutusu kesikli amber, tutamaçlar 8 px kare, döndürme düğmesi üstte daire; düğümler kare (seçili dolu), kollar amber daire; kenet işareti yeşil artı. Sağda seçime göre özellikler; çokgen aracı seçiliyken ayarları üstte amber tonlu kutuda. Çizimin üstündeki çubukta solda dosya grubu (küçük düğmeler: "Dosya ▾" menüsü, Altlık…, Bitmap izle…, Dışa aktar…, Kaynak; Kaynak açıkken amber tonlu), sağda yakınlaştırma; dar pencerede ikinci satıra sarar. Yakınlaştırma etiketi tuvalin gerçek ölçeğini gösterir (sığdır, düğmeler, tekerlek). Tuvale dosya sürüklenince çerçeve amber kesikli olur; bırakılan görüntü için imleçte iki seçenekli menü (İzleme altlığı yap, Bitmap izle…) açılır.

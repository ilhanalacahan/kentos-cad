...
Tek istisna şeridin alt kenarıdır (§7.3.1): kenarlığın altındaki hafif gölge (`--shadow-bar`) şeridi çizimin üstünde duran bir yüzey gibi ayırır. Koyu temada daha yoğundur, çünkü koyu zeminde gölge az görünür.
...
- **Alt kenar:** 1 px çizgi ve altında hafif gölge (`--shadow-bar`, §5.4); daraltılmışken sekme satırının altındadır.
